/**
 * Created by nilsbergmann on 24.02.17.
 */
/*
 ...
 */
    ...
    var GameGlobals = {
        FPS: 144, useAnimationFrame: false, boids: {flockRadius: 400, size: 100}, path: function () {
            return "http://kickassapp.com/" + Array.prototype.slice.call(arguments).join("");
    ...
    var initKickAss = function () {
        if (window.KICKASSVERSION == 'GAME_UK') {
            ...
            script.src = "http://hi.kickassapp.com/game-uk.js";
